...
<script type="text/javascript">
    ...
    $().ready(function() {
        ...
        $("#<?php echo $module ?>list").jqGrid({
            ...
            mtype: 'GET',
            datatype: 'json',
            colNames: ['<?php echo constant($module . "VariableName"); ?>', '<?php echo constant($module . "Value"); ?>'],
            colModel: [
                {name: 'Variable_name', index: 'Variable_name', width: 200, align: 'center', sortable: false, search: true, stype: 'text'},
                {name: 'Value', index: 'Value', width: 150, align: 'center', search: true, stype: 'text'}
            ],
...
<?php echo $module ?>Dialog.setOption('title', '<?php echo ServerStatus ?>');
