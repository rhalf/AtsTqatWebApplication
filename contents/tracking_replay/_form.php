        ...
        <table width="100%">
            <tr>
                ...
                <td width="80%" colspan="3">
                    <input name="<?php echo $module ?>datefrom" id="<?php echo $module ?>datefrom" type="text" class="inputstyle" style="width:100%">
                </td>
            </tr>
            <tr>
                <td><?php echo To ?></td>
                <td colspan="3">
                    <input name="<?php echo $module ?>dateTo" id="<?php echo $module ?>dateTo" type="text"class="inputstyle" style="width:100%">
                </td>
            </tr>
        </table>
    </form>
