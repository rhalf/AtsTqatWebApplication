...
<?php echo $module ?>Dialog.Close();
    ...
    $("#<?php echo $module ?>list").jqGrid("setGridWidth", $('#<?php echo $module ?>dialog').width());
            $("#<?php echo $module ?>list").jqGrid("setGridHeight", $('#<?php echo $module ?>dialog').height() - 120);
    };
...
<?php echo $module ?>loaded = true;
    ...
    url:'contents/trackers/_xml.php',
            mtype: 'GET',
            datatype: 'json',
            colNames:['', 'id', '<?php echo constant($module . "VehicleReg"); ?>', '<?php echo constant($module . "DriverName"); ?>', '<?php echo constant($module . "Owner"); ?>', '<?php echo constant($module . "Model"); ?>', '<?php echo constant($module . "Unit"); ?>', '<?php echo constant($module . "SimNo"); ?>',
<?php
if ($privilege == 1) {
    ?>
                '<?php echo constant($module . "UnitPassword"); ?>', '<?php echo constant($module . "Provider"); ?>', '<?php echo constant($module . "Type"); ?>', '<?php echo constant($module . "DBHost"); ?>', '<?php echo constant($module . "CreateDate"); ?>', '<?php echo constant($module . "DBName"); ?>', '<?php echo constant($module . "Inputs"); ?>',
<?php } ?>
            '<?php echo constant($module . "SpeedLimit"); ?>', '<?php echo constant($module . "MileageLimit"); ?>', '<?php echo constant($module . "VehicleRegExpiry"); ?>', '<?php echo constant($module . "TrackerExpiry"); ?>', '<?php echo constant($module . "MileageInit"); ?>', '<?php echo constant($module . "IdlingTime"); ?>', '<?php echo constant($module . "Note"); ?>'],
            colModel :[
...
<?php echo $module ?>Dialog.setOption('title', '<?php echo Trackers ?>');
