...
<form id="<?php echo $module ?>form" name="<?php echo $module ?>form" method="post">
    <table id="<?php echo $module ?>list">
        <select name="<?php echo $module ?>groupby" id="<?php echo $module ?>groupby" style="width:145px">
            <option value="dbhostuser"><?php echo constant($module . "HostUser"); ?></option>
...
<script type="text/javascript">
    ...
    $().ready(function() {
        ...
        $("#<?php echo $module ?>list").jqGrid({
            ...
            mtype: 'GET',
            datatype: 'json',
            colNames: ['', 'id', '<?php echo constant($module . "HostName"); ?>', '<?php echo constant($module . "IPAddress"); ?>', '<?php echo constant($module . "HostUser"); ?>'],
            colModel: [
                {name: 'act', index: 'act', width: 100, align: 'center', sortable: false, search: false, frozen: true, stype: 'none', hidedlg: true},
                {name: 'dbhostid', index: 'dbhostid', hidden: true, sortable: false, search: false, frozen: true, stype: 'none', hidedlg: true},
                {name: 'dbhostname', index: 'dbhostname', width: 150, align: 'center', search: true, frozen: true, stype: 'text'},
                {name: 'dbhostip', index: 'dbhostip', width: 150, align: 'center', search: true, stype: 'text'},
                {name: 'dbhostuser', index: 'dbhostuser', width: 100, align: 'center', search: true, stype: 'text'}
            ],
        ...
        $("#<?php echo $module ?>groupby").change(function() {
            ...
            if (vl) {
                if (vl == "clear") {
                    ...
                    GroupOption.groupText = ['<b>{0} - {1} <?php echo DBHostsCount ?></b>'];
...
<?php echo $module ?>Dialog.setOption('title', '<?php echo DBHosts ?>');
