...
function getCommand(type,cmdtype){
	if (type=='1' || type=='2' || type=='3' ){
		...
		switch (cmdtype) {
			case '1':return '4101';break; 	
			case '2':return '4102';break;
			case '3':return '4105';break;
			case '4':return '4115';break;
			case '5':return '4115';break;
			case '6':return '4902';break;
		}
	}else if (type=='5'){
		switch (cmdtype) {
			case '1':return 'A10';break; 	
			case '2':return 'A12';break;
			case '3':return 'B07';break;
			case '4':return 'C01';break;
			case '5':return 'C01';break;
			case '6':return 'F01';break;
		}
	}else if (type=='6'){
		switch (cmdtype) {
			case '1':return '4101';break; 	
...
function Event_parsing_type5(value){
	 switch (value) {
        case '1': return 'SOS Pressed';break;
        case '2':return 'Input2 active'; break;
		case '3':return 'Input3 active';break;
		case '4':return 'Input4 active';break;
		case '5':return 'Input5 active';break;
		case '9':return 'SOS Released';break;
		case '10':return 'Input2 Inactive';break;	
		case '11':return 'Input3 Inactive';break;	 
		case '12':return 'Input4 Inactive';break;	 
		case '13':return 'Input5 Inactive';break;	
		case '17':return 'Low Battery';break;	 
		case '18':return 'Low External Power';break;	 
		case '19':return 'Speeding';break;	 
		case '20':return 'Enter Geo‐fence';break;	 
		case '21':return 'Exit Geo‐fence';break;	 
		case '22':return 'External Power On';break;	 	 
		case '23':return 'External Power Off';break;	
		case '24':return 'No GPS Signal';break;	 	
		case '25':return 'Get GPS Signal';break;	 	
		case '26':return 'Enter Sleep';break;	 	
		case '27':return 'Exit Sleep';break;	 	
		case '28':return 'GPS Antenna Cut';break;	 
		case '29':return 'Device Reboot';break;	 		
	    case '30':return 'Impact';break;	 		
		case '31':return 'Heartbeat Report';break;	 		
		case '32':return 'Heading Change Report';break;	 		
		case '33':return 'Distance Interval Report';break;	 		
		case '34':return 'Current Location Report';break;	 		
		case '35':return 'Normal';break;	 
		case '36':return 'Tow Alarm';break;	 
		case '37':return 'RFID';break;	 
		case '39':return 'Picture';break;	 
		case '65':return 'Press Input 1 (SOS) to Call';break;	 
		case '66':return 'Press Input 2 to Call';break;	 
		case '67':return 'Press Input 3 to Call';break;	 
		case '68':return 'Press Input 4 to Call';break;	 
		case '69':return 'Press Input 5 to Call';break;	 
		case '70':return 'Reject Incoming Call';break;	 
		case '71':return 'Report Location after Incoming Call';break;	 
		case '72':return 'Auto Answer Incoming Call';break;	 
		case '73':return 'Listen‐in (voice monitoring)';break;					  	 	 	 	 	 	   
    };	
}
...
function Event_parsing_type6(value){
	 switch (value) {
        ...
        case 1:return 'Input 1 active';break;	
        case 2:return 'Input 2 active';break;	
		case 3:return 'Input 3 active';break;	
        case 4:return 'Input 4 active';break;	
        case 5:return 'Input 5 active';break;	
        case 10:return 'Low battery alarm';break;	
        case 11:return 'Speeding alarm';break;	
        case 12:return 'Movement alarm';break;	
        case 13:return 'Alarm of tracker entering Geo-fence scope';break;	
        case 14:return 'Alarm of tracker being turned on';break;	
        case 15:return 'Alarm of tracker entering GPS blind area';break;	
        case 16:return 'Alarm of tracker exiting GPS blind area';break;	
        case 31:return 'Input 1 inactive';break;	
        case 32:return 'Input 2 inactive';break;	
        case 33:return 'Input 3 inactive';break;	
        case 34:return 'Input 4 inactive';break;	
        case 35:return 'Input 5 inactive';break;	
        case 50:return 'External power cut alarm';break;	
        case 52:return 'Veer report';break;	
        case 53:return 'GPS antenna cut alarm ';break;	
        case 63:return 'Distance report'; break;	
	 };	
}

function Event_parsing_typeNR008(value){
	 switch (value) {
        case 80:return 'Normal';break;	
        case 81:return 'SOS Alarm';break;	
        case 82:return 'Over Speed Alarm';break;	
		case 83:return 'Geo-Fence Alarm';break;	
        case 89:return 'External Power Off';break;	
	 };	
}
...
if (ElemType == '1' || ElemType == '2' || ElemType == '3' || ElemType == '4') {
			...
			switch (stateData[0]) {
			case '0':tvar.gm_signal = OFF_LBL;break;
			case '1':tvar.gm_signal = ON_LBL;break;
			};
			switch (stateData[1]) {
			case '1':tvar.gm_power = NORMAL_LBL;break;
			case '2':tvar.gm_power = OFF_LBL;break;
			case '3':tvar.gm_power = LOW_LBL;break;
			case '4':tvar.gm_power = ERROR_LBL;break;
			};
			switch (stateData[2]) {
			case '1':tvar.gm_state = HIGH_LBL;break;
			case '2':tvar.gm_state =SHORT_LBL;break;
			case '3':tvar.gm_state = NORMAL_LBL;break;
			case '4':tvar.gm_state = ERROR_LBL;break;
			};
			...
			switch (stateData[9]) {
			case '0':tvar.gm_output1 = OFF_LBL;break;
			case '1':tvar.gm_output1 = ON_LBL;break;
			};		
			switch (stateData[14]) {
			case '0':tvar.gm_input1 = OFF_LBL;break;
			case '1':tvar.gm_input1 = ON_LBL;break;
			};			
			
			switch (stateData[15]) {
			case '0':tvar.gm_input2 = OFF_LBL;break;
			case '1':tvar.gm_input2 = ON_LBL; break;
			};
			switch (stateData[16]) {
			case '0':tvar.gm_input3 = OFF_LBL; break;
			case '1':tvar.gm_input3 = ON_LBL; break;
			};
			switch (stateData[17]) {
			case '0':tvar.gm_input4 = OFF_LBL;break;
			case '1':tvar.gm_input4 = ON_LBL;break;
			};
			...
			switch (stateData[9]) {
			case '1':tvar.gm_output1 = OFF_LBL;break;
			case '0':tvar.gm_output1 = ON_LBL;break;
			};
			...
			if (ElemInps=='25'){
				...
				case '0':tvar.gm_input5 = ON_LBL;break;
				case '1':tvar.gm_input5 = OFF_LBL;break;
				};
				...
				switch (stateData[3].substr(6,1)) {
				case '0':tvar.gm_input2 = ON_LBL;break;
				case '1':tvar.gm_input2 = OFF_LBL;break;
				};
				
				switch (stateData[3].substr(3,1)) {
				case '0':tvar.gm_input5 = OFF_LBL;break;
				case '1':tvar.gm_input5 =ON_LBL;break;
				};	
			}// end check inputs
			
			switch (stateData[3].substr(5,1)) {
			case '0':tvar.gm_input3 = ON_LBL;break;
			case '1':tvar.gm_input3 = OFF_LBL;break;
			};					
			...
			case '0':tvar.gm_output2 = ON_LBL;break;
			case '1':tvar.gm_output2 = OFF_LBL;break;
			};	
			switch (stateData[3].substr(13,1)) {
			case '0':tvar.gm_output3 = ON_LBL;break;
			case '1':tvar.gm_output3 = OFF_LBL;break;
			};	
			switch (stateData[3].substr(12,1)) {
			case '0':tvar.gm_output4 = ON_LBL;break;
			case '1':tvar.gm_output4 = OFF_LBL;break;
			};	
			switch (stateData[3].substr(11,1)) {
			case '0':tvar.gm_output5 = ON_LBL;break;
			case '1':tvar.gm_output5 = OFF_LBL;break;
			};
