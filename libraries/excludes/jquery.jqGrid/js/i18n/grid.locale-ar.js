...
$.extend($.jgrid,{
	...
	edit : {
		...
		bCancel: "إلغاء",
		bClose: "إغلاق",
		saveData: "تغيرت المعطيات هل تريد السجل ?",
		bYes: "نعم",
		bNo: "لا",
		bExit: "إلغاء",
		msg: {
	...
	del : {
		caption: "حذف",
		msg: "حذف السجلات المحددة ?",
		bSubmit: "حذف",
		bCancel: "إلغاء"
	},
	nav : {
		edittext: " ",
		edittitle: "تغيير السجل المحدد",
		addtext:" ",
		addtitle: "إضافة سجل",
		deltext: " ",
		deltitle: "حذف السجل المحدد",
		searchtext: " ",
