(function (a) {
    a.widget("ui.dropdownchecklist", {
        ...
        _createDropItem: function (g, f, o, l, q, h, e, k) {
            ...
            t.addClass("ui-widget-content");//changed from  ui-state-default
            if (e) {
        ...
        _toggleDropContainer: function (e) {
            ...
            var d = function (f) {
                if ((f != null) && f.dropWrapper.isOpen) {
					...
					g.addClass("ui-corner-all");//added
					g.removeClass("ui-corner-top");//added
            ...
            var b = function (n) {
                if (!n.dropWrapper.isOpen) {
                    ...
                    if ((g.positionHow == null) || (g.positionHow == "absolute")) {
                        n.dropWrapper.css({
                            position: "absolute",
                            top: n.controlWrapper.position().top + n.controlWrapper.outerHeight()-5 + "px",
					...
					j.addClass("ui-corner-top");//added
					j.removeClass("ui-corner-all");//added
        ...
        _init: function () {
			...
			c.controlSelector.addClass('ui-corner-all');//added
